########################################################################################################################################################
# Note: please run project.py file.
########################################################################################################################################################
...
#     dice_coefficient = (2 * intersection) / (np.sum(predicted_mask) + np.sum(true_mask))
#     return dice_coefficient

def calculate_mae(total_frames, perfect_frame, result_frame):
    abs_diff = abs(perfect_frame - result_frame)
    mae_score = abs_diff/total_frames
    return mae_score
